const Info = () => {
  return (
    <section className="info" id="info">
      <h2 className="info__feature-title title-featured">What is AIO</h2>
      ...
      <h3 className="info__feature-title--sub">The possibilities are beyond your imagination</h3>
      <a className="link-featured" href="/">
        Explore The Library
      </a>
      <div className="info__card">
        <h4 className="info__card-title title-featured">Chatbots</h4>
      ...
      <div className="info__card">
        <h4 className="info__card-title title-featured">Knowledgebase</h4>
        <p className="info__card-text">
      ...
      <div className="info__card">
        <h4 className="info__card-title title-featured">Education</h4>
        <p className="info__card-text">
