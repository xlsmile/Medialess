const Info = () => {
  return (
    <section className="info" id="info">
      ...
      <a className="info__feature-link" href="/">
        Explore The Library
      </a>
      <div className="info__card">
        <h4 className="info__card-title">Chatbots</h4>
        <p>
      ...
      <div className="info__card">
        <h4 className="info__card-title">Knowledgebase</h4>
        <p>
      ...
      <div className="info__card">
        <h4 className="info__card-title">Education</h4>
        <p>
